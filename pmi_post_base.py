...
def usage():
    ...
    ## To build PMI of certain data:
        ...
        >> wu.build_cooccurrence(targetList='resources/TDIwordlist.owl.pkl',output="resources/TDI_cooccur_5.pkl", threshold=5)    ## will dump to resources/bk.cooccur.5.pkl 

        >> wu.build_PMI(path="resources/TDI_pmi.pkl")

        or specify a new path for storing PMI data 
        >> wu.build_PMI(path="resources/TDI_pmi_5.pkl")
